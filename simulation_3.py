...
if __name__ == '__main__':
    ...
    link_layer.add_link(link_3.Link(router_d, 0, server_2, 0, 30))
    ...
    for i in range(3):
        client_1.udt_send(1, 3, i, 0, 0, 'Sample data %d that is too long to deliver through the current MTU length of 50 characters.' % i)
        client_2.udt_send(2, 4, i, 0, 0, 'Sample data %d that is too long to deliver through the current MTU length of 50 characters.' % i)
